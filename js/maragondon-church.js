...
sessionStorage.setItem("currentStage","maragondon-church")
...
const nextDialog = () => {
    ...
    // setTimeout(() => {
        if(dialogNumber + 1 === MARAG_CHURCH_DIALOG.length){
...
const insertDialogMessage = () => {
    if(MARAG_CHURCH_DIALOG[dialogNumber]){
        contentContainer.innerHTML = `
        <div class="dialog-container space-between">
            <p class="dialog">${MARAG_CHURCH_DIALOG[dialogNumber]}</p>
            <div class="end-x">
